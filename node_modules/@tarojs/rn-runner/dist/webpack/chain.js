...
exports.getWxTransformerLoader = fp_1.pipe(exports.mergeOption, lodash_1.partial(getLoader, path.resolve(__dirname, '../loaders/tsTransformerLoader')));
exports.getJSXToStylesSheetLoader = fp_1.pipe(exports.mergeOption, lodash_1.partial(getLoader, path.resolve(__dirname, '../loaders/JSXToStylesSheetLoader')));
exports.getBabelLoader = fp_1.pipe(exports.mergeOption, lodash_1.partial(getLoader, path.resolve(__dirname, '../loaders/babelLoader')));
...
exports.getProvidePlugin = (options) => {
    return lodash_1.partial(getPlugin, webpack_1.ProvidePlugin)([options]);
};
exports.getStatsPlugin = (path, options) => {
    return lodash_1.partial(getPlugin, StatsPlugin)([path, options]);
};
exports.getRNPlugin = args => {
    RNPlugin_1.default.init();
    return lodash_1.partial(getPlugin, RNPlugin_1.default)([args]);
};
exports.getModule = (appPath, { sourceDir, entry, designWidth, deviceRatio, buildAdapter, constantsReplaceList, enableSourceMap, cssLoaderOption, lessLoaderOption, sassLoaderOption, stylusLoaderOption, fontUrlLoaderOption, imageUrlLoaderOption, mediaUrlLoaderOption, postcss, compile, babel, alias }) => {
    ...
    // @ts-ignore
    const JSXToStylesSheetLoader = exports.getJSXToStylesSheetLoader([
        {
            buildAdapter
        }
    ]);
    const babelLoader = exports.getBabelLoader([
        {
            babel,
            buildAdapter
        }
    ...
    const rule = {
        ...
        media: {
            ...
            use: {
                urlLoader: exports.getUrlLoader([
                    defaultMediaUrlLoaderOption,
                    Object.assign(Object.assign({ name: `${staticDirectory}/media/[name].[ext]` }, mediaUrlLoaderOption), { 
        ...
        font: {
            ...
            use: {
                urlLoader: exports.getUrlLoader([
                    ...
                    Object.assign(Object.assign({ name: `${staticDirectory}/fonts/[name].[ext]` }, fontUrlLoaderOption), { limit: false })
                ])
            }
        },
        image: {
            ...
            use: {
                urlLoader: exports.getUrlLoader([
                    ...
                    Object.assign(Object.assign({ name: `${staticDirectory}/images/[name].[ext]` }, imageUrlLoaderOption), { limit: false })
                ])
            }
        }
    };
...
function getOutput(appPath, [{ outputRoot, publicPath, buildAdapter, isBuildPlugin }, customOutput]) {
    return Object.assign({ path: path.join(appPath, outputRoot), publicPath, filename: '[name].js', chunkFilename: '[name].js', globalObject: globalObjectMap[buildAdapter], 
        // library:'App',
        // libraryExport: 'default',
        libraryTarget: 'commonjs2' }, customOutput);
}
