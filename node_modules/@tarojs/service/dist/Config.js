...
class Config {
    ...
    init() {
        this.configPath = path.join(this.appPath, constants_1.CONFIG_DIR_NAME, constants_1.DEFAULT_CONFIG_FILE);
        if (!fs.existsSync(this.configPath)) {
            this.initialConfig = {};
            this.isInitSuccess = false;
        }
        else {
            this.initialConfig = require(this.configPath)(lodash_1.merge);
