...
class Compiler {
    ...
    constructor(appPath) {
        ...
        this.projectConfig = require(path.join(appPath, helper_1.PROJECT_CONFIG))(_.merge);
        ...
        this.entryFilePath = helper_1.resolveScriptPath(path.join(this.sourceDir, config_1.default.ENTRY));
