...
var Index = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Index() {
    ...
    }, _this.$usedState = ["anonymousState__temp5", "loopArray6", "$compid__16", "styles", "arr", "resultEnum"], _this.customComponents = ["MMNavigation"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var loopArray6 = arr.map(function (ele, _anonIdx) {
        ele = {
