...
var Route = /*#__PURE__*/function (_Taro$Component) {
  ...
  _createClass(Route, [{
    ...
    value: function computeMatch(currentLocation) {
      var pKey = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.props.key;
      var pPath = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.props.path;
      var isIndex = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this.props.isIndex;
      var isTabBar = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : this.props.isTabBar;
    ...
    value: function componentWillReceiveProps(nProps) {
      ...
      var nextMatched = this.computeMatch(nProps.currentLocation, nProps.key, nProps.path, nProps.isIndex, nProps.isTabBar);
  ...
  return function (_ref7) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      try {
        ...
        var key = window.history.state.key * 1;
